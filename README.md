...
Поэтому и был написан данный простенький пакет, имплементирующий API сервиса.
...
## Установка
```
pip install https://github.com/sshumikhin/unofficial-vk-id-python-sdk/raw/master/dist/unofficial_vk_id_sdk-0.2.0.tar.gz
```
...
3) #### Объявления хендлера для обработки переданных code, device_id и state
```
