...
async def exchange_code(
    ...
    try:
        return await VK_ID_APP_INSTANCE.__code_exchanger(
...
async def get_user_public_info(access_token: str) -> Error | User:
    try:
        return await VK_ID_APP_INSTANCE.__user_info(access_token=access_token)
    except AttributeError:
        raise AppNotInitialized
...
async def refresh_access_token(
    ...
    try:
        return await VK_ID_APP_INSTANCE.__token_refresher(
